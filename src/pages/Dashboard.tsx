...
import { TrendingUp, TrendingDown, Wallet, Loader2, Plus, Layers, Eye, AlertCircle } from "lucide-react";
        ...
        {activeTab === "tesouraria" ? (
          <div className="space-y-8 animate-in fade-in duration-700">
            ...
            <div className={`grid gap-6 grid-cols-1 ${canManageFinances ? 'lg:grid-cols-[1fr_320px]' : ''}`}>
              <div className={cn("space-y-6", canManageFinances ? "lg:col-span-1" : "")}>
                {canManageFinances && (
                          ...
                          {loading ? (
                            ...
                            <ResponsiveContainer width="100%" height="100%">
                              <BarChart data={chartData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }} barGap={6}>
                                ...
                                />
                                <Bar dataKey="entradas" fill="hsl(var(--chart-blue))" radius={[6, 6, 0, 0]} barSize={24} />
                                <Bar dataKey="saidas" fill="hsl(var(--chart-pink))" radius={[6, 6, 0, 0]} barSize={24} />
                              </BarChart>
                            </ResponsiveContainer>
                          )}
                        </div>
                    ...
                    <Card className="stat-card border-none overflow-hidden">
                      <CardHeader className="bg-secondary/10 border-b border-border/40 py-5 flex flex-row items-center justify-between">
                        <div>
                          ...
                          <p className="text-[11px] font-medium text-muted-foreground uppercase tracking-widest mt-0.5">Dízimos & Ofertas</p>
                        </div>
