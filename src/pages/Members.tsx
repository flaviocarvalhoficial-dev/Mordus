...
function MembersList() {
  ...
  const [visibleColumns, setVisibleColumns] = useState<string[]>(["full_name", "contact", "congregation", "status"]);
                      ...
                      <TableCell className="pl-8 text-left">
                        <div className="flex items-center gap-4">
                          <button
                            ...
                            className="h-11 w-11 rounded-full bg-secondary/50 flex items-center justify-center overflow-hidden border border-border/40 shadow-sm ring-2 ring-transparent group-hover:ring-primary/20 transition-all shrink-0"
                          >
